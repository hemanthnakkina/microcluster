...
import (
	...
	"github.com/hemanthnakkina/microcluster/microstack/api"
	"github.com/hemanthnakkina/microcluster/microstack/database"
	"github.com/hemanthnakkina/microcluster/microstack/version"
...
func (c *cmdDaemon) Command() *cobra.Command {
	cmd := &cobra.Command{
		Use:     "microstackd",
		Short:   "Example daemon for Microstack Cluster - This will start a daemon with a running control socket and no database",
